          ...
          <v-container>
            <v-row wrap>
              <v-col class="mb-0 py-0" cols="12" sm="8">
                <v-text-field
                  :label="$vuetify.lang.t('$vuetify.campaign.cols.name.title')"
              ...
              <v-col class="mb-0 py-0" cols="12" sm="4">
                <v-switch
                  ...
                  "
                  :label="
                    $vuetify.lang.t('$vuetify.campaign.cols.enabled.title')
                  "
                ></v-switch>
              </v-col>
            </v-row>
...
export default {
  ...
  props: {
    ...
    form: {
      type: Object,
      default: function() {
        return CONSTANTS.defaultCampaignForm();
      }
    }
  },
  validations() {
  ...
  methods: {
    ...
    getFormParam() {
      ...
      switch (this.dialog.action) {
        case "edit":
          params["url"] = URLPath.CAMPAIGN.EDIT.URI.replace(
            "{CAMPAIGN_ID}",
            this.form["id"]
          );
          var data = this._.omit(this.form, ["id"]);
          params["data"] = data;
          params["method"] = URLPath.CAMPAIGN.EDIT.METHOD;
          break;
        case "create":
          params["url"] = URLPath.CAMPAIGN.CREATE.URI;
          params["method"] = URLPath.CAMPAIGN.CREATE.METHOD;
  ...
  computed: {
    errorsName() {
      ...
      !this.$v.form.name.required &&
        errors.push(
          this.$vuetify.lang.t("$vuetify.campaign.cols.name.required")
        );
